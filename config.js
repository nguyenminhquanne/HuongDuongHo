const CONFIG = {
    ...
    introDesc: `Trái đất vốn lạ thường, mà em làm sao để anh vẫn nhớ hộp đậu bắp kèm theo hộp cá diên chiên :)))
    ...
    messDesc: 'Vậy em đã biết anh làm gì chưa :)))).',
    btnAccept: 'Biết chớt liềnnnnn <3',
